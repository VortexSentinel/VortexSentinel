...
role:        DevOps & Cloud Engineer (Transitioning)
education:   Advanced Cert · Cloud Computing & DevOps · IIT Roorkee (via Intellipaat)
currently:   Docker · Kubernetes · Terraform · Python for DevOps
focus:       CI/CD · Infrastructure as Code · AWS Services · Linux Admin
email:       rajnish96jha@gmail.com
```
...
|---|---|---|
| [AWS CI/CD Pipeline](https://github.com/VortexSentinel/nextwork-web-project-cicd) | CodePipeline · CodeBuild · CodeDeploy · Maven | End-to-end CI/CD for a Java web app on EC2 with artifact management |
| [GitFlow Workflow — Zendriix](https://github.com/VortexSentinel/zendriix-git-workflow) | Git · GitFlow · GitHub | Branching strategy for a simulated enterprise product release cycle |
| [AWS Deployment Project](https://github.com/VortexSentinel/aws-deployment-project) | AWS EC2 · S3 · IAM | Cloud deployment with IAM roles, storage, and compute configuration |
| [Git Learning Log](https://github.com/VortexSentinel/git-learning-log) | Git · GitHub | Documented Git fundamentals, branching, rebase, cherry-pick, merge conflicts |
...
<div align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com?user=VortexSentinel&theme=github-dark&hide_border=true" />
</div>
